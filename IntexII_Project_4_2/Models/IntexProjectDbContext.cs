...
public partial class IntexProjectDbContext : DbContext
{
    public IntexProjectDbContext()
    {
    }

    public IntexProjectDbContext(DbContextOptions<IntexProjectDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:myfreesqldbserverphethean.database.windows.net,1433;Initial Catalog=IntexIIProjectDb;Persist Security Info=False;User ID=phethean;Password=Jazzer@34;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
